...
const FractalGalaxyShader: React.FC<FractalGalaxyShaderProps> = ({ width, height }) => {
  ...
  // Original GLSL shader code converted to Skia SL
  const shaderSource = `    
    // SKSL version of the fractal galaxy shader
...
vec4 main(vec2 fragCoord) {
    ...
    return mix(freqs[3] - 0.3, 1.0, v) * vec4(1.5*freqs[2] * t * t * t, 1.2*freqs[1] * t * t, freqs[3]*t, 1.0) + c2 + starcolor;
}
  `;
